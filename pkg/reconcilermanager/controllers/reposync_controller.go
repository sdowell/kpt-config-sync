...
func (r *RepoSyncReconciler) populateContainerEnvs(ctx context.Context, rs *v1beta1.RepoSync, notificationEnabled bool, reconcilerName string, notificationConfig *v1beta1.NotificationConfig) map[string][]corev1.EnvVar {
